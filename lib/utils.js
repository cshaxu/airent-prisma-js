...
exports.getUpdatedFields = exports.buildWhere = exports.batchLoadTopMany = exports.batchLoad = void 0;
var lodash_1 = require("lodash");
var consts_1 = require("./consts");
function getUpdatedFields(original, updated, primaryFields, dateFields) {
    var updatedPrimaryFields = primaryFields.filter(function (field) { return original[field] !== updated[field]; });
    var updatedDateFields = dateFields.filter(function (field) { var _a, _b; return ((_a = original[field]) === null || _a === void 0 ? void 0 : _a.getTime()) !== ((_b = updated[field]) === null || _b === void 0 ? void 0 : _b.getTime()); });
    return __spreadArray(__spreadArray([], updatedPrimaryFields, true), updatedDateFields, true);
}
exports.getUpdatedFields = getUpdatedFields;
function batchLoad(loader_1, keys_1) {
    return __awaiter(this, arguments, void 0, function (loader, keys, batchSize) {
